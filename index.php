		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card text-left">
					...
					<div class="card-body">
						<span class="btn btn-primary" id="abremodalnuevo"> 
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmnuevoU">
						...
						<label>Nombre</label>
						<input type="" class="form-control input-sm" id="nombre" name="nombreU">
						<label>Año</label>
						<input type="" class="form-control input-sm" id="anio" name="anioU">
						<label>Empresa</label>
						<input type="" class="form-control input-sm" id="empresa" name="empresaU">
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
			...
			$.ajax({
				...
				success:function(r){
					if (r==1) {
						...
						alertify.success("Agregado cpn exito :D");
					}else{
		...
		alertify.confirm('Eliminar un juego', 'Seguro de eliminar este juego pro:(?', function(){ 
			...
			$.ajax({
				...
				success:function(r){
					if (r==1) {
						$('#tablaDatatable').load('tabla.php');
						alertify.success("Eliminar con exito !");
						}else{
